<?php
    ...
    */
    ...
    class Student {
         ...
         * @param string $password La nueva contraseña del estudiante.
         ...
         */
        public function updateStudent($id, $licenseID, $name, $lastName, $email, $password, $phoneNumber, $address)
        {
            ...
            // Preparación de la consulta SQL
            $stmt = $this->con->prepare("UPDATE students SET licenseID = ?, name = ?, lastName = ?, email = ?, password = ?, phoneNumber = ?, address = ? WHERE ID = ?");
            $stmt->bind_param("sssssssi", $licenseID, $name, $lastName, $email, $password, $phoneNumber, $address, $id);
